...
var banner_d= '<img src="player_banner.jpg" style="display: block;    position: fixed;    top: 50%;    left: 0;    bottom: 0;    right: 0;    z-index: -5;    width: 100%;    transform: translateY(-50%);    opacity: 0.7;    url(\"player_banner.jpg\");"/>';

inpss454fod5rwles.innerHTML='<inp'+'ut type="file" class="lk" id="inpssle" multiple="multiple" name="files" accept="'+inpss45435rwles_oid+'"/><br/><button class="btn" onclick="run_modelop();" id="infdfpssle" style="transition: 0.2s;width:90%"><div style="padding:4px;">Abrir Arquivos (Video, Audio e Image)'+inpss454ftu35rwles_oid+'</div></button> '+banner_d;
